...
public class UserLikesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case LOADING:
                ...
                viewHolder = new UserLikesAdapter.LoadingVH(v2);
                break;
        }
        return viewHolder;
    }
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        viewHolder = new UserLikesAdapter.MovieVH(v1);
        return viewHolder;
    }
...
//        Log.e("movieResultsSize", String.valueOf(result.getUrls().getFull()));
        switch (getItemViewType(position)) {
            case ITEM:
                final UserLikesAdapter.MovieVH movieVH = (UserLikesAdapter.MovieVH) holder;
...
//                if (position != 0)
//                    if (position % Utils.adPos == 0) {
//                        ((FrameLayout)((UserLikesAdapter.MovieVH) holder).ad_view_container).setVisibility(View.VISIBLE);
//                        AdView mAdView = new AdView(context);
//                        mAdView.setAdSize(AdSize.BANNER);
//                        mAdView.setAdUnitId(context.getString(R.string.banner_id));
//                        ((FrameLayout)((UserLikesAdapter.MovieVH) holder).ad_view_container).addView(mAdView);
