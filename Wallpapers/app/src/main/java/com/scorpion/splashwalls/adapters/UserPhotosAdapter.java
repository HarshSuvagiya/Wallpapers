...
public class UserPhotosAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<UserPhotosModel> movieResults;
    ...
    public List<UserPhotosModel> getMovies() {
        return movieResults;
    }

    public void setMovies(List<UserPhotosModel> movieResults) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case LOADING:
                ...
                viewHolder = new UserPhotosAdapter.LoadingVH(v2);
                break;
        }
        return viewHolder;
    }
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        viewHolder = new UserPhotosAdapter.MovieVH(v1);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final UserPhotosModel result = movieResults.get(position); // Movie
//        Log.e("movieResultsSize", String.valueOf(result.getUrls().getFull()));
        switch (getItemViewType(position)) {
            case ITEM:
                final UserPhotosAdapter.MovieVH movieVH = (UserPhotosAdapter.MovieVH) holder;
...
//                if (position != 0)
//                    if (position % Utils.adPos == 0) {
//                        ((FrameLayout)((UserPhotosAdapter.MovieVH) holder).ad_view_container).setVisibility(View.VISIBLE);
//                        AdView mAdView = new AdView(context);
//                        mAdView.setAdSize(AdSize.BANNER);
//                        mAdView.setAdUnitId(context.getString(R.string.banner_id));
//                        ((FrameLayout)((UserPhotosAdapter.MovieVH) holder).ad_view_container).addView(mAdView);
...
//                    }
    ...
    public void add(UserPhotosModel r) {
        movieResults.add(r);
        notifyItemInserted(movieResults.size() - 1);
    }

    public void addAll(List<UserPhotosModel> moveResults) {
        for (UserPhotosModel result : moveResults) {
            add(result);
//            Log.e("IDS",result.getId());
        }
    }

    public void remove(UserPhotosModel r) {
    ...
    public void removeLoadingFooter() {
        ...
        UserPhotosModel result = getItem(position);
    ...
    public UserPhotosModel getItem(int position) {
