...
public class UserPhotosModel {
    ...
    {
        return "ClassPojo [current_user_collections = "+current_user_collections+", color = "+color+", sponsorship = "+sponsorship+", created_at = "+created_at+", description = "+description+", liked_by_user = "+liked_by_user+", urls = "+urls+", alt_description = "+alt_description+", updated_at = "+updated_at+", width = "+width+", links = "+links+", id = "+id+", categories = "+categories+", promoted_at = "+promoted_at+", user = "+user+", height = "+height+", likes = "+likes+"]";
    }
    ...
    public class Sponsorship
    {
        ...
        public String[] getImpression_urls ()
        {
            return impression_urls;
        }

        public void setImpression_urls (String[] impression_urls)
        {
        ...
        public String toString()
        {
            return "ClassPojo [sponsor = "+sponsor+", tagline = "+tagline+", impression_urls = "+impression_urls+"]";
        }
    }
