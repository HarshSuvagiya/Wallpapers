...
public class UserCollectionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<UserCollectionsModel> movieResults;
    ...
    public List<UserCollectionsModel> getMovies() {
        return movieResults;
    }

    public void setMovies(List<UserCollectionsModel> movieResults) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case LOADING:
                ...
                viewHolder = new UserCollectionsAdapter.LoadingVH(v2);
                break;
        }
        return viewHolder;
    }
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        viewHolder = new UserCollectionsAdapter.MovieVH(v1);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final UserCollectionsModel result = movieResults.get(position); // Movie
//        Log.e("movieResultsSize", String.valueOf(result.getUrls().getFull()));
        switch (getItemViewType(position)) {
            case ITEM:
                final UserCollectionsAdapter.MovieVH movieVH = (UserCollectionsAdapter.MovieVH) holder;
...
//                    if (position != 0)
//                        if (position % Utils.adPos == 0) {
//                            ((FrameLayout)((UserCollectionsAdapter.MovieVH) holder).ad_view_container).setVisibility(View.VISIBLE);
//                            AdView mAdView = new AdView(context);
//                            mAdView.setAdSize(AdSize.BANNER);
//                            mAdView.setAdUnitId(context.getString(R.string.banner_id));
//                            ((FrameLayout)((UserCollectionsAdapter.MovieVH) holder).ad_view_container).addView(mAdView);
...
//                        }
    ...
    public void add(UserCollectionsModel r) {
        movieResults.add(r);
        notifyItemInserted(movieResults.size() - 1);
    }

    public void addAll(List<UserCollectionsModel> moveResults) {
        for (UserCollectionsModel result : moveResults) {
            add(result);
//            Log.e("IDS", result.getId());
        }
    }

    public void remove(UserCollectionsModel r) {
    ...
    public void removeLoadingFooter() {
        ...
        UserCollectionsModel result = getItem(position);
    ...
    public UserCollectionsModel getItem(int position) {
